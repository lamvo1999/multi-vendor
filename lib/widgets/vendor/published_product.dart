...
class PublisedProduct extends StatefulWidget {
  const PublisedProduct({Key? key}) : super(key: key);

  @override
  State<PublisedProduct> createState() => _PublisedProductState();
}

class _PublisedProductState extends State<PublisedProduct> {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: StreamBuilder(
        stream: _services.getPublishedProductByVendor(id: id),
